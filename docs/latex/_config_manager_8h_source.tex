...
\hypertarget{_config_manager_8h_source}{}\label{_config_manager_8h_source}\index{foundation/config/ConfigManager.h@{foundation/config/ConfigManager.h}}
\mbox{\hyperlink{_config_manager_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{preprocessor}{\#pragma\ once}}
\DoxyCodeLine{00002\ }
\DoxyCodeLine{00003\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_config_section_8h}{ConfigSection.h}}"{}}}
\DoxyCodeLine{00004\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_event_dispatcher_8h}{../events/EventDispatcher.h}}"{}}}
\DoxyCodeLine{00005\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_common_events_8h}{../events/CommonEvents.h}}"{}}}
...
\DoxyCodeLine{00015\ \ \ \ \ \textcolor{keyword}{static}\ ConfigManager\&\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a235ae8efbb74f182ab1b084ffd25ab8e}{getInstance}}()\ \{}
...
\DoxyCodeLine{00021\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a60bc56ba03c8c9fed60628b7ad18a3cc}{loadFromFile}}(\textcolor{keyword}{const}\ std::string\&\ filename)\ \{}
...
\DoxyCodeLine{00027\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00028\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00029\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a9225235b0e6d477da494514c8e8637d5}{loadFromStream}}(file);}
\DoxyCodeLine{00030\ \ \ \ \ \}}
\DoxyCodeLine{00031\ \ \ \ \ }
\DoxyCodeLine{00032\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_abfbf61b4f263b8aa9993ee497a6dfb90}{saveToFile}}(\textcolor{keyword}{const}\ std::string\&\ filename)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00038\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00039\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00040\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_af1f3c4ec2230a71dcef2a182127032df}{saveToStream}}(file);}
\DoxyCodeLine{00041\ \ \ \ \ \}}
\DoxyCodeLine{00042\ \ \ \ \ }
\DoxyCodeLine{00043\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_ada70697c3d589dd484fd428f7f0d6ccf}{loadDefaults}}()\ \{}
...
\DoxyCodeLine{00086\ \ \ \ \ T\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a741b7291be849d95c97791e333af5fda}{getValue}}(\textcolor{keyword}{const}\ std::string\&\ key,\ \textcolor{keyword}{const}\ T\&\ defaultValue\ =\ T\{\})\ \textcolor{keyword}{const}\ \{}
\DoxyCodeLine{00087\ \ \ \ \ \ \ \ \ std::lock\_guard<std::mutex>\ lock(m\_mutex);}
\DoxyCodeLine{00088\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ m\_rootSection.\mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_section_a9801b738e259ae91990d9ac8f2d09f1e}{getValueByPath}}(key,\ defaultValue);}
\DoxyCodeLine{00089\ \ \ \ \ \}}
\DoxyCodeLine{00090\ \ \ \ \ }
\DoxyCodeLine{00091\ \ \ \ \ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00092\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a13644a079641b9b8b8c40ab55d2d9b42}{setValue}}(\textcolor{keyword}{const}\ std::string\&\ key,\ \textcolor{keyword}{const}\ T\&\ value)\ \{}
\DoxyCodeLine{00093\ \ \ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00100\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_voxel_editor_1_1_events_1_1_configuration_changed_event}{Events::ConfigurationChangedEvent}}\ event(key);}
\DoxyCodeLine{00101\ \ \ \ \ \ \ \ \ \ \ \ \ m\_eventDispatcher-\/>dispatch(event);}
\DoxyCodeLine{00102\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00103\ \ \ \ \ \}}
\DoxyCodeLine{00104\ \ \ \ \ }
\DoxyCodeLine{00105\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_aa05e8fd8f821597b445b04fd268a1536}{hasValue}}(\textcolor{keyword}{const}\ std::string\&\ key)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00108\ \ \ \ \ \}}
\DoxyCodeLine{00109\ \ \ \ \ }
\DoxyCodeLine{00110\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a99d680021a7f78c8d01535387e1b8420}{removeValue}}(\textcolor{keyword}{const}\ std::string\&\ key)\ \{}
\DoxyCodeLine{00111\ \ \ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00129\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_voxel_editor_1_1_events_1_1_configuration_changed_event}{Events::ConfigurationChangedEvent}}\ event(key);}
\DoxyCodeLine{00130\ \ \ \ \ \ \ \ \ \ \ \ \ m\_eventDispatcher-\/>dispatch(event);}
\DoxyCodeLine{00131\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00132\ \ \ \ \ \}}
\DoxyCodeLine{00133\ \ \ \ \ }
\DoxyCodeLine{00134\ \ \ \ \ \textcolor{comment}{//\ Section\ access}}
\DoxyCodeLine{00135\ \ \ \ \ std::shared\_ptr<ConfigSection>\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_ab63eadecc0668dc0c8076e4c6cf1329a}{getSection}}(\textcolor{keyword}{const}\ std::string\&\ path)\ \{}
...
\DoxyCodeLine{00141\ \ \ \ \ \}}
\DoxyCodeLine{00142\ \ \ \ \ }
\DoxyCodeLine{00143\ \ \ \ \ std::shared\_ptr<const\ ConfigSection>\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a521ddb298b4cbfc3671c1a4bd85c8165}{getSection}}(\textcolor{keyword}{const}\ std::string\&\ path)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00149\ \ \ \ \ \}}
\DoxyCodeLine{00150\ \ \ \ \ }
\DoxyCodeLine{00151\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a01295081442fa8102bdfb322608174dc}{createSection}}(\textcolor{keyword}{const}\ std::string\&\ path)\ \{}
...
\DoxyCodeLine{00159\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_aab736eb0186f3348f179318c31ec63df}{setEventDispatcher}}(\mbox{\hyperlink{class_voxel_editor_1_1_events_1_1_event_dispatcher}{Events::EventDispatcher}}*\ dispatcher)\ \{}
...
\DoxyCodeLine{00165\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_ae5472736f70c8943ddefbf75cb862639}{clear}}()\ \{}
\DoxyCodeLine{00166\ \ \ \ \ \ \ \ \ std::lock\_guard<std::mutex>\ lock(m\_mutex);}
\DoxyCodeLine{00167\ \ \ \ \ \ \ \ \ m\_rootSection.clear();}
\DoxyCodeLine{00168\ \ \ \ \ \}}
\DoxyCodeLine{00169\ \ \ \ \ }
\DoxyCodeLine{00170\ \ \ \ \ std::vector<std::string>\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a3aba910ed6c2680e744a84d1c50cb030}{getAllKeys}}()\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00178\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_a9225235b0e6d477da494514c8e8637d5}{loadFromStream}}(std::istream\&\ stream)\ \{}
...
\DoxyCodeLine{00206\ \ \ \ \ \}}
\DoxyCodeLine{00207\ \ \ \ \ }
\DoxyCodeLine{00208\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_af1f3c4ec2230a71dcef2a182127032df}{saveToStream}}(std::ostream\&\ stream)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00218\ \ \ \ \ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_section}{ConfigSection}}\ m\_rootSection;}
\DoxyCodeLine{00219\ \ \ \ \ \mbox{\hyperlink{class_voxel_editor_1_1_events_1_1_event_dispatcher}{Events::EventDispatcher}}*\ m\_eventDispatcher\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00220\ \ \ \ \ \textcolor{keyword}{mutable}\ std::mutex\ m\_mutex;}
\DoxyCodeLine{00221\ \ \ \ \ }
\DoxyCodeLine{00222\ \ \ \ \ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager}{ConfigManager}}()\ \{}
\DoxyCodeLine{00223\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_voxel_editor_1_1_config_1_1_config_manager_ada70697c3d589dd484fd428f7f0d6ccf}{loadDefaults}}();}
\DoxyCodeLine{00224\ \ \ \ \ \}}
\DoxyCodeLine{00225\ \ \ \ \ }
