...
\hypertarget{md_core_2undo__redo_2_d_e_s_i_g_n}{}\label{md_core_2undo__redo_2_d_e_s_i_g_n}\index{Undo/Redo System Subsystem@{Undo/Redo System Subsystem}}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ \mbox{\hyperlink{namespace_voxel_editor_1_1_input_a8b2a9d37fd35de3bfe892807b743a530ab9ece18c950afbfa6b0fdbfa4ff731d3}{T}},\ \textcolor{keyword}{typename}...\ Args>}
...
\DoxyCodeLine{\ \ \ \ }
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a910a33278b905ebb61af91a4d9f54941}{UndoRedoCallback}}\ m\_undoRedoCallback;}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a96da3416b15b7e8019ccd228bde4fcf7}{MemoryPressureCallback}}\ m\_memoryPressureCallback;}
\DoxyCodeLine{\ \ \ \ }
...
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52}{CommandType}}\ getType()\ \textcolor{keyword}{const}\ =\ 0;}
\DoxyCodeLine{\ \ \ \ }
\DoxyCodeLine{\ \ \ \ \textcolor{comment}{//\ Memory\ management}}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{enum\ class}\ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52}{CommandType}}\ \{}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52a8d0f48dacad4dcf230ccb8a1a14df1ac}{VoxelEdit}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52a6ff9dd0d34f65181173c1e4bc39939de}{Selection}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52a03937134cedab9078be39a77ee3a48a0}{Group}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52a967d35e40f3f95b1f538bd248640bf3b}{Camera}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52a03a21915504df93cf5dba0636080f62e}{Workspace}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52a72d6d7a1885885bb55a565fd1070581a}{Import}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52a141a5b46e2087dc7a80a43710c2dacfb}{Composite}}}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{keyword}{public}:}
\DoxyCodeLine{\ \ \ \ VoxelEditCommand(VoxelDataManager*\ voxelManager,\ \textcolor{keyword}{const}\ Vector3i\&\ position,\ \mbox{\hyperlink{test___event_dispatcher_8cpp_a809cb57e6c71414ebeedcdbcf7631be9}{VoxelResolution}}\ resolution,\ \textcolor{keywordtype}{bool}\ newValue);}
\DoxyCodeLine{\ \ \ \ }
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52}{CommandType}}\ getType()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ CommandType::VoxelEdit;\ \}}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{test___event_dispatcher_8cpp_a809cb57e6c71414ebeedcdbcf7631be9}{VoxelResolution}}\ m\_resolution;}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52}{CommandType}}\ getType()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ CommandType::Selection;\ \}}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{size\_t}\ getMemoryUsage()\ \textcolor{keyword}{const\ override};}
\DoxyCodeLine{\ \ \ \ }
\DoxyCodeLine{\textcolor{keyword}{private}:}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52}{CommandType}}\ getType()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ CommandType::Group;\ \}}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{size\_t}\ getMemoryUsage()\ \textcolor{keyword}{const\ override};}
\DoxyCodeLine{\ \ \ \ }
\DoxyCodeLine{\textcolor{keyword}{private}:}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_groups_a2b4a825e76c367f8e8190958acd5f940}{GroupId}}\ m\_createdGroupId;}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ GroupManager*\ m\_groupManager;}
\DoxyCodeLine{\ \ \ \ VoxelDataManager*\ m\_voxelManager;}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_groups_a2b4a825e76c367f8e8190958acd5f940}{GroupId}}\ m\_groupId;}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52}{CommandType}}\ getType()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ CommandType::Camera;\ \}}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{size\_t}\ getMemoryUsage()\ \textcolor{keyword}{const\ override};}
\DoxyCodeLine{\ \ \ \ }
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{bool}\ canMergeWith(\textcolor{keyword}{const}\ Command\&\ other)\ \textcolor{keyword}{const\ override};}
\DoxyCodeLine{\ \ \ \ std::unique\_ptr<Command>\ mergeWith(std::unique\_ptr<Command>\ other)\ \textcolor{keyword}{override};}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_file_i_o_ac4a753aec4547a1d45a29bd68a9f0970a5767debca0b70ab557300d85ea5a9492}{CameraState}}\ m\_oldState;}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_file_i_o_ac4a753aec4547a1d45a29bd68a9f0970a5767debca0b70ab557300d85ea5a9492}{CameraState}}\ m\_newState;}
\DoxyCodeLine{\ \ \ \ }
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a8ec1ccbb9e9262a466ea8f9825a10a52}{CommandType}}\ getType()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ CommandType::Composite;\ \}}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{size\_t}\ getMemoryUsage()\ \textcolor{keyword}{const\ override};}
\DoxyCodeLine{\ \ \ \ }
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \mbox{\hyperlink{test___event_dispatcher_8cpp_a809cb57e6c71414ebeedcdbcf7631be9}{VoxelResolution}}\ activeResolution;}
\DoxyCodeLine{\ \ \ \ \};}
\DoxyCodeLine{\ \ \ \ }
...
\DoxyCodeLine{\ \ \ \ }
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{void}\ addVoxelChange(\textcolor{keyword}{const}\ Vector3i\&\ position,\ \mbox{\hyperlink{test___event_dispatcher_8cpp_a809cb57e6c71414ebeedcdbcf7631be9}{VoxelResolution}}\ resolution,\ \textcolor{keywordtype}{bool}\ oldValue,\ \textcolor{keywordtype}{bool}\ newValue);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{enum\ class}\ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1}{UndoRedoEventType}}\ \{}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1a9ee4e041d9d1f5d3483c6b6ae9b38576}{CommandExecuted}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1aef41557e92a599b2432d54f6cb25f6ca}{CommandUndone}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1a9baaf3ba77f4e6e092bfdf1ef57d8812}{CommandRedone}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1a83ce0d0e4ebd7d8e4ab4820481a7577a}{HistoryCleared}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1a79049c3d0a0b0602b576407a8fd40e3f}{TransactionStarted}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1af302f58cc298c396752c1a5f87ccbe9c}{TransactionCommitted}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1a107c6cb0a79fcc2eb3249c69c95bdf6e}{TransactionRolledBack}},}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1a1b3a89c10c25b2a230e1f1fe112a2825}{MemoryPressure}}}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{struct\ }UndoRedoEvent\ \{}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a0bcfe43b9a0d672261417b29927704b1}{UndoRedoEventType}}\ type;}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{using\ }\mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a910a33278b905ebb61af91a4d9f54941}{UndoRedoCallback}}\ =\ std::function<void(\textcolor{keyword}{const}\ UndoRedoEvent\&)>;}
\DoxyCodeLine{\textcolor{keyword}{using\ }\mbox{\hyperlink{namespace_voxel_editor_1_1_undo_redo_a96da3416b15b7e8019ccd228bde4fcf7}{MemoryPressureCallback}}\ =\ std::function<void(\textcolor{keywordtype}{size\_t}\ currentUsage,\ \textcolor{keywordtype}{size\_t}\ maxUsage)>;}
