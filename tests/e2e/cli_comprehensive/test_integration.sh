...
place 256cm 0cm 128cm
place 128cm 0cm 256cm
place 256cm 0cm 256cm

# Add medium structures
resolution 64cm
place 128cm 128cm 128cm
place 192cm 128cm 128cm
place 256cm 128cm 256cm
place 320cm 128cm 256cm

# Add details
resolution 32cm
place 160cm 192cm 160cm
place 192cm 192cm 160cm
place 288cm 192cm 288cm
...
for i in $(seq 0 19); do
    echo "place $((i*32))cm 0cm 96cm" >> "$TEST_DIR/undo_stress_cmd.txt"
done
