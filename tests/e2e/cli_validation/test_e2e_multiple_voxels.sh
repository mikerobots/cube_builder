...
# Create test commands - place voxels at exact positions to demonstrate new requirements
# 16cm voxels can now be placed at any 1cm position, not just 16cm boundaries
cat > "$OUTPUT_DIR/multiple_voxels_commands.txt" << 'EOF'
workspace 5m 5m 5m
resolution 16cm
place -47cm 9cm -49cm
place -43cm 25cm -51cm
place 49cm 7cm -47cm
place 51cm 23cm -53cm
place 3cm 17cm 47cm
view iso
zoom 0.8
