...
for res in "${RESOLUTIONS[@]}"; do
    ...
    # Create test commands for this resolution - use exact positions to test new requirements
    # All voxels can now be placed at any 1cm position regardless of their size
    case "$res" in
        "1cm") coords="3cm 7cm 5cm" ;;
        "4cm") coords="7cm 11cm 13cm" ;;
        "16cm") coords="17cm 23cm 19cm" ;;
        "64cm") coords="67cm 71cm 73cm" ;;
        "256cm") coords="259cm 263cm 257cm" ;;
        *) coords="0cm 0cm 0cm" ;;
    esac
...
EOF
    ...
    timeout 30s "$CLI_BINARY" < "$OUTPUT_DIR/resolution_${res}_commands.txt" || {
