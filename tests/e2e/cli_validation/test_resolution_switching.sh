...
for res in "${RESOLUTIONS[@]}"; do
    ...
    # Create test commands for this resolution - use coordinates that align with the resolution
    case "$res" in
        "1cm") coords="1cm 1cm 1cm" ;;
        "4cm") coords="4cm 4cm 4cm" ;;
        "8cm") coords="8cm 8cm 8cm" ;;
        "16cm") coords="16cm 16cm 16cm" ;;
        "32cm") coords="32cm 32cm 32cm" ;;
        *) coords="0cm 0cm 0cm" ;;
    esac
