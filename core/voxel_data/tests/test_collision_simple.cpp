...
TEST(CollisionSimple, DifferentSizeOverlap) {
    ...
    Vector3f voxelPos(0.16f, 0.0f, 0.16f);
    ...
    EXPECT_FALSE(manager.setVoxelAtWorldPos(Vector3f(0.06f, 0.0f, 0.06f), VoxelResolution::Size_1cm, true));
    EXPECT_FALSE(manager.setVoxelAtWorldPos(Vector3f(0.21f, 0.0f, 0.21f), VoxelResolution::Size_1cm, true));
    EXPECT_FALSE(manager.setVoxelAtWorldPos(Vector3f(0.10f, 0.0f, 0.10f), VoxelResolution::Size_1cm, true));
    
    // These should succeed (outside the 16cm voxel)
    EXPECT_TRUE(manager.setVoxelAtWorldPos(Vector3f(0.05f, 0.0f, 0.06f), VoxelResolution::Size_1cm, true));
    EXPECT_TRUE(manager.setVoxelAtWorldPos(Vector3f(0.22f, 0.0f, 0.06f), VoxelResolution::Size_1cm, true));
    EXPECT_TRUE(manager.setVoxelAtWorldPos(Vector3f(0.06f, 0.0f, 0.22f), VoxelResolution::Size_1cm, true));
}