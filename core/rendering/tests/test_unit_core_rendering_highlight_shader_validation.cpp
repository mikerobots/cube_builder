...
TEST_F(HighlightShaderValidationTest, ValidateHighlightRendererCreation) {
    ...
    // Create a simple test camera using OrbitCamera
    Camera::OrbitCamera camera;
    camera.setPosition(Math::WorldCoordinates(Math::Vector3f(0, 0, 5)));
    camera.setTarget(Math::WorldCoordinates(Math::Vector3f(0, 0, 0)));
    camera.setUp(Math::WorldCoordinates(Math::Vector3f(0, 1, 0)));
...
TEST_F(HighlightShaderValidationTest, ValidateShaderWithDifferentStates) {
    ...
    // Create test camera using OrbitCamera
    Camera::OrbitCamera camera;
    camera.setPosition(Math::WorldCoordinates(Math::Vector3f(0, 0, 5)));
    camera.setTarget(Math::WorldCoordinates(Math::Vector3f(0, 0, 0)));
    camera.setUp(Math::WorldCoordinates(Math::Vector3f(0, 1, 0)));
...
TEST_F(HighlightShaderValidationTest, ValidateMultipleHighlights) {
    ...
    // Create test camera using OrbitCamera
    Camera::OrbitCamera camera;
    camera.setPosition(Math::WorldCoordinates(Math::Vector3f(0, 0, 10)));
    camera.setTarget(Math::WorldCoordinates(Math::Vector3f(0, 0, 0)));
    camera.setUp(Math::WorldCoordinates(Math::Vector3f(0, 1, 0)));
    camera.setFieldOfView(45.0f);
    camera.setAspectRatio(800.0f/600.0f);
...
TEST_F(HighlightShaderValidationTest, ValidateFaceHighlightRendering) {
    ...
    // Create test camera using OrbitCamera
    Camera::OrbitCamera camera;
    camera.setPosition(Math::WorldCoordinates(Math::Vector3f(2, 2, 2)));
    camera.setTarget(Math::WorldCoordinates(Math::Vector3f(0, 0, 0)));
    camera.setUp(Math::WorldCoordinates(Math::Vector3f(0, 1, 0)));
    camera.setFieldOfView(45.0f);
    camera.setAspectRatio(800.0f/600.0f);
